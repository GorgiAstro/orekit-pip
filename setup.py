...
ext_modules=[
    Extension(
        ...
        extra_link_args=['-L' + str(JAVA_HOME) + '/lib', '-ljava', '-L' + str(JAVA_HOME) + '/lib/server', '-ljvm', '-Wl,-rpath=' + str(JAVA_HOME) + 'lib' + ':' + str(JAVA_HOME) + '/lib/server', '-Wl,-S'],
        export_symbols=[],
        swig_opts=[],
        depends=[],
        language=None,
